    ...
    >
      <div className="container">
        ...
        <div className="about__body">
          <p>
            Fort de plus de 6 ans d&apos;expérience dans l&apos;industrie en
          ...
          <p>
            J&apos;aide également les éditeurs à élargir ou adapter leur
            inventaire aux réseaux d&apos;échange publicitaire. Avec mon
            penchant pour résoudre les problèmes de suivi, je vous assure
            d&apos;obtenir le meilleur mélange de suivi média pour votre
            campagne.
          </p>
          <p>
            Au cours des deux dernières décennies, tout en faisant de Paris mon
            lieu de résidence principal et originaire de La Réunion, j&apos;ai
            ...
            végétalien, motivé par son engagement envers la préservation de
            l&apos;environnement.
          </p>
          ...
          <NavLink to="/contact">
            <h4 className="about__signature">Jean-Ludovic Albany</h4>
          </NavLink>
        </div>
      </div>
    </motion.div>
